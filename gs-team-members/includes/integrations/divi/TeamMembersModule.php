...
/**
 * Native Divi 5 Team Members module.
 */
class TeamMembersModule implements DependencyInterface {
	 ...
	 * @var string
	 */
	const NAME = 'gsteam/team-members';
	...
	public static function register_module() {
		$module_json_folder_path = GSTEAM_PLUGIN_DIR . 'includes/integrations/divi/visual-builder/src';
	...
	public static function get_default_shortcode_id() {
		$shortcodes = \GSTEAM\get_shortcodes();
	...
	public static function render_shortcode_html( $shortcode_id ) {
		...
		if ( ! $shortcode_id ) {
			return sprintf(
				...
				esc_html__( 'Please select a GS Team shortcode.', 'gsteam' )
			);
		}
	...
	public static function render_callback( $attrs, $content, $block, $elements ) {
		...
		$module_inner = HTMLUtility::render(
			[
				'tag'               => 'div',
				'attributes'        => [
					'class' => 'et_pb_module_inner gs-team-members',
				],
