...
$vg = get_current_visibility_group();
$ribbon_visibility = get_member_visibility_field( $vg, 'member_ribbon' );
$badge_visibility  = get_member_visibility_field( $vg, 'member_featured_badge' );

if ( $featured_badge === 'on' && $enable_featuring === 'on' && $is_featured && is_visible( $badge_visibility ) ): ?>
    <div class="<?php print_visible_classes( $badge_visibility, 'gs_team_featured_badge' ); ?>">
...
<?php if ( !empty($ribon) && $display_ribbon === 'on' && is_visible( $ribbon_visibility ) ): ?>
    <div class="<?php print_visible_classes( $ribbon_visibility, 'gs_team_ribbon' ); ?>"><?php echo esc_html( $ribon ); ?></div>
