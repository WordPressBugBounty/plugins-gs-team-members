...
(function ($) {
    ...
    function _slideIn(panel, options) {
        var originalMarginLeft = parseFloat($body.css('margin-left')) || 0;
        $body.data('gs-original-margin-left', originalMarginLeft);
        ...
        switch (options.side) {
            case 'left':
                ...
                bodyAnimation['margin-left'] = originalMarginLeft + panelWidth;
    ...
    $.panelslider.close = function (callback) {
        var originalMarginLeft = $body.data('gs-original-margin-left') || 0;
        ...
        switch (active.data('side')) {
            case 'left':
                bodyAnimation['margin-left'] = originalMarginLeft;
                panelAnimation.left = '-=' + panelWidth;
                break;
